...
//
// Параметры:
//  Настройки - Структура - настройки печати:
//   * ИспользоватьПодписиИПечати - Булево - использовать подписи и печати;
//   * СкрыватьПодписиИПечатиДляРедактирования - Булево - скрывать подписи и печати для редактирования;
//   * ПроверкаПроведенияПередПечатью - Булево - проверять проведение перед печатью.
//
